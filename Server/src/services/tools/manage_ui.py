...
@mcp_for_unity_tool(
    ...
    description=(
        ...
        "In play mode, render_ui first queues a WaitForEndOfFrame capture and returns pending=true; "
        "a later call retrieves the PNG. Editor-mode rendering is best-effort and may be blank. "
        "UXML styles must use <ui:Style> with the ui namespace, not bare <Style>; "
