...
namespace MCPForUnity.Editor.Tools.Prefabs
{
    ...
    public static class ManagePrefabs
    {
        ...
        private const string SupportedActions = ACTION_CREATE_FROM_GAMEOBJECT + ", " + ACTION_GET_INFO + ", " + ACTION_GET_HIERARCHY + ", " + ACTION_MODIFY_CONTENTS + ", " + ACTION_APPLY_INSTANCE_OVERRIDES + ", " + ACTION_REVERT_INSTANCE_OVERRIDES + ", " + ACTION_UNPACK_INSTANCE;
